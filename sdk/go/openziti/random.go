...
func NewRandom(ctx *pulumi.Context,
	...
	var resource Random
	err := ctx.RegisterResource("openziti:index:Random", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRandom(ctx *pulumi.Context,
	...
	var resource Random
	err := ctx.ReadResource("openziti:index:Random", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func (i *Random) ToOutput(ctx context.Context) pulumix.Output[*Random] {
	return pulumix.Output[*Random]{
		OutputState: i.ToRandomOutputWithContext(ctx).OutputState,
	}
}
