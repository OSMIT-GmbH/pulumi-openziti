...
namespace OsmitGmbh.Openziti
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("OsmitGmbh.Openziti.version.txt");
    ...
    internal sealed class OpenzitiResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public OpenzitiResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
